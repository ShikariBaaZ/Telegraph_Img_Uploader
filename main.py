...
START_TEXT = """**Hello ❤️{}❤️

I am simplest media or file to telegra.ph link uploader bot.**

>> I will help you to convert under 5MB photo or video to telegraph link.

**Tap help button or hit /help for more Info.**"""

HELP_TEXT = """**Hey, Follow these steps for converting Media/File to Telegraph:**

▷ Just give me a media should be less than 5MB.
▷ Then I will download it.
▷ After tht i will upload it to the telegra.ph link.
"""

ABOUT_TEXT = """--**About Me**-- ❤️


👨‍💻 **Developer :** [Shikari](https://t.me/The_Shikarii)

📢 **Channel :** [LᎯᏯLᏋᎦᎦ ᏌᎵDᎯᎿᏋᎦ](https://t.me/Lawless_Updates)

👥 **Feedback :** [Tap Here](https://t.me/ShikariSupportNetwork)

🌐 **Source :** [👉🏻Tap Here👈🏻](https://github.com/ZauteKm/Image-Upload-Bot)
...
async def telegraph_upload(bot, update):
    ...
    if FSub == 400:
        return
    medianame = "./DOWNLOADS/" + "The_Shikarii/TGraphRoBot"
    ...
    try:
        ...
        return
    await text.edit_text(
        text=f"<b>Link :-</b> <code>https://telegra.ph{response[0]}</code>\n\n<b>Thank You For Using Me:- \nPlease Subscribe ❤️ [@The_Shikarii](https://t.me/ShikariSupportNetwork/6)</b>",
        disable_web_page_preview=True,
    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned,you are not able to use me. Contact my [Support Group](https://t.me/ShikariSupportNetwork).",
                parse_mode="markdown",
                disable_web_page_preview=True,
